...
def implement_dict_transcripts_properties(
    ...
    for transcript_name in dict_transcripts_properties:
        ...
        dict_transcripts_properties_total[new_transcript_name] = (
            dict_transcripts_properties[transcript_name]
        )


def implement_dict_gene_status(
    dict_gene_status: dict, dict_gene_status_total: dict, ID_transcriptome: str
) -> None:
    """
...
def implement_dict_gene_transcripts_denovo(
...
def implement_dict_transcrit_filtered_orfs(
...
def implement_dict_pos_unspliced_ORFs_plus_stop(
    ...
    for orf_name in dict_pos_unspliced_ORFs_plus_stop:
        ...
        dict_pos_unspliced_ORFs_plus_stop_total[new_orf_name] = (
            dict_pos_unspliced_ORFs_plus_stop[orf_name]
        )


def implement_sublist_transcripts_overlap(
    sublist_transcripts_overlap: list,
    sublist_transcripts_overlap_total: list,
    ID_transcriptome: str,
) -> list:
    """
...
def implement_dict_all_ORFs_filtered_with_stop(
    ...
    for orf_name in dict_all_ORFs_filtered_with_stop:
        new_orf_name = ID_transcriptome + "_" + orf_name
        dict_all_ORFs_filtered_with_stop_total[new_orf_name] = (
            dict_all_ORFs_filtered_with_stop[orf_name]
        )


def implement_dict_transcript_fasta_denovo(
    ...
    for transcript_name in dict_transcript_fasta_denovo:
        new_transcript_name = ID_transcriptome + "_" + transcript_name
        dict_transcript_fasta_denovo_total[new_transcript_name] = (
            dict_transcript_fasta_denovo[transcript_name]
        )
