...
def graphical_select_genome_folder_strat2(dico_file_and_dir : dict, radiobutton_frame : Tk, win : Tk, value_ref_name : StringVar) -> None:
    """
    ...
    label = customtkinter.CTkLabel(radiobutton_frame, text="V", width=30,height=25, text_color = "#37589c",corner_radius=4,fg_color="white", font = ("Arial", 15)).place(relx = 0.38, rely = 0.65)
    name_ref = value_ref_name.get()
    if dico_file_and_dir["path_to_transcriptome_repository"] != "" and name_ref != "":
        button_DESMAN_run = customtkinter.CTkButton(master=win,width=100,height=50, text ='RUN', command= lambda: graphical_Close_strat2(win)).place(relx = 0.05, rely = 0.81,anchor = 'w')


def graphical_select_transcriptome_folder_strat2(dico_file_and_dir : dict, radiobutton_frame : Tk, win : Tk, value_ref_name : StringVar) ->  None:
    """
    ...
    label = customtkinter.CTkLabel(radiobutton_frame, text="V", width=30,height=25, text_color = "#37589c",corner_radius=4,fg_color="white", font = ("Arial", 15)).place(relx = 0.905, rely =  0.65)
    name_ref = value_ref_name.get()
...
def graphical_enter_mandatory_strat2(win : Tk, radiobutton_frame : Tk, my_font : tuple, dico_file_and_dir : dict) -> StringVar:
    """
    ...
    entree.bind('<KeyRelease>',lambda e: graphical_activate_with_text_strat2(win, dico_file_and_dir))
    # buttons
    label = customtkinter.CTkLabel(radiobutton_frame, text="",font=my_font,corner_radius=4, width=30,height=25, fg_color="white").place(relx = 0.38, rely = 0.65)
    label = customtkinter.CTkLabel(radiobutton_frame, text="",font=my_font,corner_radius=4, width=30,height=25, fg_color="white").place(relx = 0.905, rely =  0.65)
    button_genome_dir = customtkinter.CTkButton(master=radiobutton_frame,width=150,height=25, text ='Genome directory', command= lambda: graphical_select_genome_folder_strat2(dico_file_and_dir, radiobutton_frame, win, value_ref_name)).place(relx = 0.02, rely = 0.75,anchor = 'w')
    button_transcriptome_dir = customtkinter.CTkButton(master=radiobutton_frame,width=150,height=25, text ='Transcriptome directory', command= lambda: graphical_select_transcriptome_folder_strat2(dico_file_and_dir, radiobutton_frame, win, value_ref_name)).place(relx = 0.54, rely = 0.75,anchor = 'w')
...
def graphical_select_prot_database_strat2(radiobutton_frame2 : Tk, dico_file_and_dir : dict) -> None:
    """
    ...
    label = customtkinter.CTkLabel(radiobutton_frame2, text="V", width=30,height=25, text_color = "#37589c",corner_radius=4, font = ("Arial", 15)).place(relx = 0.36, rely = 0.418)


def graphical_select_nucl_database_strat2(sidebar_frame_left : Tk, dico_file_and_dir : dict) -> None:
    """
...
def graphical_enter_databases_strat2(sidebar_frame_left : Tk, my_font : tuple, dico_file_and_dir : dict) -> tuple:
    """
    ...
    """
    button_prot_file = customtkinter.CTkButton(master=sidebar_frame_left,width=150,height=25, text ='BLAST protein database', command= lambda: graphical_select_prot_database_strat2(sidebar_frame_left, dico_file_and_dir)).place(relx = 0.02, rely = 0.18,anchor = 'w')
    button_nucl_file = customtkinter.CTkButton(master=sidebar_frame_left,width=150,height=25, text ='BLAST nucl database', command= lambda: graphical_select_nucl_database_strat2(sidebar_frame_left, dico_file_and_dir)).place(relx = 0.02, rely = 0.68,anchor = 'w')
    var_blastp_mode = IntVar(value=2)
    # Define a Checkbox
    case_1 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="sensitive", variable=var_blastp_mode, value=1).place(relx = 0.02, rely = 0.38,anchor = 'w')
    case_2 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="more sensitive", variable=var_blastp_mode, value=2).place(relx = 0.22, rely = 0.38,anchor = 'w')
    case_3 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="very sensitive", variable=var_blastp_mode, value=3).place(relx = 0.49, rely = 0.38,anchor = 'w')
    case_4 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="ultra sensitive", variable=var_blastp_mode, value=4).place(relx = 0.75, rely = 0.38,anchor = 'w')
...
def graphical_TPM_threeshold_strat2(sidebar_frame_right : Tk, my_font : tuple) -> StringVar:
    """
...
def graphical_remove_undir_transcripts_strat2(sidebar_frame_right : Tk, my_font : tuple) -> IntVar:
    """
...
def graphical_min_size_5UTR_strat2(sidebar_frame_right : Tk, my_font : tuple) -> StringVar:
    """
...
def graphical_min_size_3UTR_strat2(sidebar_frame_right : Tk, my_font : tuple) -> StringVar:
    """
...
def graphical_filter_genic_transcripts_strat2(sidebar_frame_right : Tk, my_font : tuple) -> IntVar:
    """
...
def my_graphical_interface_strategy2():
    ...
    sidebar_frame_left = customtkinter.CTkFrame(master=win, width=480, height=360, corner_radius=5)
    sidebar_frame_left.place(relx = 0.03, rely = 0.32,anchor = 'w')
    sidebar_frame_left.grid_rowconfigure(4, weight=1)

    sidebar_frame_right = customtkinter.CTkFrame(master=win, width=420, height=570, corner_radius=5)
    ...
    radiobutton_frame = customtkinter.CTkFrame(win, width=450, height=120, corner_radius=5, fg_color="#484747")
    radiobutton_frame.place(relx = 0.045, rely = 0.14,anchor = 'w', )

    radiobutton_frame2 = customtkinter.CTkFrame(win, width=450, height=200, corner_radius=5, fg_color="#484747")
    radiobutton_frame2.place(relx = 0.045, rely = 0.44,anchor = 'w', )

    ### variables

    dico_file_and_dir = {"strategy": "2",
                        "query" : "",
    ...
    # databases
    value_ref_name =  graphical_enter_mandatory_strat2(win, radiobutton_frame, my_font, dico_file_and_dir)
    var_blastp_mode, var_blastnucl_mode = graphical_enter_databases_strat2(radiobutton_frame2, my_font, dico_file_and_dir)
    ...
    var_undir_transcr = graphical_remove_undir_transcripts_strat2(sidebar_frame_right, my_font)
    var_intergenic, var_intronic, var_antisense, var_genic = graphical_transcript_location_strat2(sidebar_frame_right, my_font)
    ...
    var_filter_genic = graphical_filter_genic_transcripts_strat2(sidebar_frame_right, my_font)
