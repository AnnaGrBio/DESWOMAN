...
def graphical_select_genome_folder_strat1(dico_file_and_dir : dict, radiobutton_frame : customtkinter.CTkFrame, win : customtkinter.CTk, value_ref_name : StringVar) -> None:
    """
    ...
    label = customtkinter.CTkLabel(radiobutton_frame, text="V", width=30,height=25, text_color = "#37589c",corner_radius=4,fg_color="white", font = ("Arial", 15)).place(relx = 0.38, rely = 0.61)
    name_ref = value_ref_name.get()
    if dico_file_and_dir["path_to_transcriptome_repository"] != "" and name_ref != "":
        button_DESMAN_run = customtkinter.CTkButton(master=win,width=100,height=50, text ='RUN', command= lambda: graphical_Close_strat1(win)).place(relx = 0.05, rely = 0.91,anchor = 'w')


def graphical_select_transcriptome_folder_strat1(dico_file_and_dir : dict, radiobutton_frame : customtkinter.CTkFrame, win : Tk, value_ref_name : StringVar) -> None:
    """
    ...
    label = customtkinter.CTkLabel(radiobutton_frame, text="V", width=30,height=25, text_color = "#37589c",corner_radius=4,fg_color="white", font = ("Arial", 15)).place(relx = 0.905, rely =  0.61)
    name_ref = value_ref_name.get()
...
def graphical_activate_with_text_strat1(win : Tk, dico_file_and_dir : dict) -> None:
    ...
    Returns:
        None
    """
    if dico_file_and_dir["path_to_genome_repository"] != "" and dico_file_and_dir["path_to_transcriptome_repository"] != "":
        button_DESMAN_run = customtkinter.CTkButton(master=win,width=100,height=50, text ='RUN', command= lambda: graphical_Close_strat1(win)).place(relx = 0.05, rely = 0.91,anchor = 'w')

    
def graphical_enter_mandatory_strat1(win : Tk, radiobutton_frame : customtkinter.CTkFrame, my_font : tuple, dico_file_and_dir : dict) -> StringVar:
    """
    ...
    """
    # query name
    label = customtkinter.CTkLabel(radiobutton_frame, text="Enter query name : ",font=my_font).place(relx = 0.02, rely = 0.3,anchor = 'w')
    ...
    entree.bind('<KeyRelease>',lambda e: graphical_activate_with_text_strat1(win, dico_file_and_dir))
    # buttons
    label = customtkinter.CTkLabel(radiobutton_frame, text="",font=my_font,corner_radius=4, width=30,height=25, fg_color="white").place(relx = 0.38, rely = 0.61)
    label = customtkinter.CTkLabel(radiobutton_frame, text="",font=my_font,corner_radius=4, width=30,height=25, fg_color="white").place(relx = 0.905, rely =  0.61)
    button_genome_dir = customtkinter.CTkButton(master=radiobutton_frame,width=150,height=25, text ='Genome directory', command= lambda: graphical_select_genome_folder_strat1(dico_file_and_dir, radiobutton_frame, win, value_ref_name)).place(relx = 0.02, rely = 0.75,anchor = 'w')
    button_transcriptome_dir = customtkinter.CTkButton(master=radiobutton_frame,width=150,height=25, text ='Transcriptome directory', command= lambda: graphical_select_transcriptome_folder_strat1(dico_file_and_dir, radiobutton_frame, win, value_ref_name)).place(relx = 0.54, rely = 0.75,anchor = 'w')
...
def graphical_select_prot_database_strat1(sidebar_frame_left : customtkinter.CTkFrame, dico_file_and_dir : dict) -> None:
    """
    ...
    Returns:
        None
    """
    filepath = askopenfilename(title="Select a dataset",filetypes=[('fasta file','.fa .fna .fasta'),('all files','.*')])
    dico_file_and_dir["link_database_outgroup_prot"] = filepath
    label = customtkinter.CTkLabel(sidebar_frame_left, text="V", width=30,height=25, text_color = "#37589c",corner_radius=4, font = ("Arial", 15)).place(relx = 0.36, rely = 0.418)


def graphical_select_nucl_database_strat1(sidebar_frame_left : customtkinter.CTkFrame, dico_file_and_dir : dict) -> None:
    """
    ...
    label = customtkinter.CTkLabel(sidebar_frame_left, text="V", width=30,height=25, text_color = "#37589c",corner_radius=4, font = ("Arial", 15)).place(relx = 0.36, rely = 0.72)


def graphical_enter_databases_strat1(sidebar_frame_left : customtkinter.CTkFrame, my_font : tuple, dico_file_and_dir : dict) -> tuple:
    """
    ...
    """
    button_prot_file = customtkinter.CTkButton(master=sidebar_frame_left,width=150,height=25, text ='BLAST protein database', command= lambda: graphical_select_prot_database_strat1(sidebar_frame_left, dico_file_and_dir)).place(relx = 0.02, rely = 0.46,anchor = 'w')
    button_nucl_file = customtkinter.CTkButton(master=sidebar_frame_left,width=150,height=25, text ='BLAST nucl database', command= lambda: graphical_select_nucl_database_strat1(sidebar_frame_left, dico_file_and_dir)).place(relx = 0.02, rely = 0.76,anchor = 'w')
    var_blastp_mode = IntVar(value=2)
    # Define a Checkbox
    case_1 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="sensitive", variable=var_blastp_mode, value=1).place(relx = 0.02, rely = 0.58,anchor = 'w')
    case_2 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="more sensitive", variable=var_blastp_mode, value=2).place(relx = 0.22, rely = 0.58,anchor = 'w')
    case_3 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="very sensitive", variable=var_blastp_mode, value=3).place(relx = 0.49, rely = 0.58,anchor = 'w')
    case_4 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="ultra sensitive", variable=var_blastp_mode, value=4).place(relx = 0.75, rely = 0.58,anchor = 'w')
    var_blastnucl_mode = IntVar(value=2)
    # Define a Checkbox
    case_5 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="0.1", variable=var_blastnucl_mode, value=1).place(relx = 0.02, rely = 0.88,anchor = 'w')
    case_6 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="0.01", variable=var_blastnucl_mode, value=2).place(relx = 0.16, rely = 0.88,anchor = 'w')
    case_7 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="0.001", variable=var_blastnucl_mode, value=3).place(relx = 0.32, rely = 0.88,anchor = 'w')
    case_8 = customtkinter.CTkRadioButton(master=sidebar_frame_left, text="0.0001", variable=var_blastnucl_mode, value=4).place(relx = 0.50, rely = 0.88,anchor = 'w')
...
def graphical_TPM_threeshold_strat1(sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> StringVar:
    """
    ...
    """
    label = customtkinter.CTkLabel(sidebar_frame_right, text="Minimum TPM level for transcripts",font=my_font).place(relx = 0.02, rely = 0.05,anchor = 'w')
    var_TPM = StringVar(value=0)
    choice_TPM = Spinbox(sidebar_frame_right, from_=0.5, to=10, increment=.5, textvariable=var_TPM,wrap=True).place(relx = 0.02, rely = 0.1,anchor = 'w')
    return var_TPM


def graphical_filter_TE_strat1(sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> IntVar:
    """
    ...
    # Define empty variables
        ...
        label = customtkinter.CTkLabel(sidebar_frame_right, text="Filter TEs",font=my_font).place(relx = 0.02, rely = 0.18,anchor = 'w')
    # Define a Checkbox 
        case_filter_TE = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="False", variable=var_filter_TE, value=1).place(relx = 0.02, rely = 0.22,anchor = 'w')
        case_no_filter_TEs = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="True", variable=var_filter_TE, value=2).place(relx = 0.18, rely = 0.22,anchor = 'w')
    except BaseException as e:
        pass
    return var_filter_TE


def graphical_remove_undir_transcripts_strat1(sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> IntVar:
    """
    ...
    label = customtkinter.CTkLabel(sidebar_frame_right, text="Remove unoriented transcripts",font=my_font).place(relx = 0.02, rely = 0.28,anchor = 'w')
    # Define a Checkbox
    case_remove_undir_tr = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="False", variable=var_undir_transcr, value=1).place(relx = 0.02, rely = 0.32,anchor = 'w')
    case_no_remove_undir_tr = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="True", variable=var_undir_transcr, value=2).place(relx = 0.18, rely = 0.32,anchor = 'w')
    return var_undir_transcr


def graphical_transcript_location_strat1(sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> tuple:
    """
    ...
    var_genic = IntVar()
    label = customtkinter.CTkLabel(sidebar_frame_right, text="Transcript location",font=my_font).place(relx = 0.02, rely = 0.38,anchor = 'w')
    # Define a Checkbox
    case_intergenic = customtkinter.CTkCheckBox(master=sidebar_frame_right, text="intergenic", variable=var_intergenic, onvalue=1, offvalue=0).place(relx = 0.02, rely = 0.42,anchor = 'w')
    case_intronic = customtkinter.CTkCheckBox(master=sidebar_frame_right, text="intronic", variable=var_intronic, onvalue=1, offvalue=0).place(relx = 0.29, rely = 0.42,anchor = 'w')
    case_antisense = customtkinter.CTkCheckBox(master=sidebar_frame_right, text="antisense", variable=var_antisense, onvalue=1, offvalue=0).place(relx = 0.56, rely = 0.42,anchor = 'w')
    case_genic = customtkinter.CTkCheckBox(master=sidebar_frame_right, text="genic", variable=var_genic, onvalue=1, offvalue=0).place(relx = 0.83, rely = 0.42,anchor = 'w')
    return var_intergenic, var_intronic, var_antisense, var_genic


def graphical_ORFs_choice_strat1(sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> IntVar:
    """
    ...
    label = customtkinter.CTkLabel(sidebar_frame_right, text="ORF choice",font=my_font).place(relx = 0.02, rely = 0.49,anchor = 'w')
    # Define a Checkbox
    case_all_orfs = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="All ORFS", variable=var_orf_choice, value=1).place(relx = 0.02, rely = 0.53,anchor = 'w')
    case_intronic = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="Longest ORF", variable=var_orf_choice, value=2).place(relx = 0.02, rely = 0.58,anchor = 'w')
    case_antisense = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="Highest Kozac score", variable=var_orf_choice, value=3).place(relx = 0.02, rely = 0.63,anchor = 'w')
    case_genic = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="First ORF in transcript", variable=var_orf_choice, value=4).place(relx = 0.02, rely = 0.68,anchor = 'w')
    return var_orf_choice


def graphical_min_size_5UTR_strat1(sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> StringVar:
    """
    ...
    """
    label = customtkinter.CTkLabel(sidebar_frame_right, text="Min 5'UTR size (nucl)",font=my_font).place(relx = 0.02, rely = 0.75,anchor = 'w')
    var_5UTR = StringVar(value=0)
    choice_5prime_min_size = Spinbox(sidebar_frame_right, from_=0, to=100, textvariable=var_5UTR,wrap=True).place(relx = 0.02, rely = 0.79,anchor = 'w')
    return var_5UTR


def graphical_min_size_3UTR_strat1(sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> StringVar:
    """
    ...
    """
    label = customtkinter.CTkLabel(sidebar_frame_right, text="Min 3'UTR size (nucl)",font=my_font).place(relx = 0.54, rely = 0.75,anchor = 'w')
    var_3UTR = StringVar(value=0)
    choice_3prime_min_size = Spinbox(sidebar_frame_right, from_=0, to=100, textvariable=var_3UTR,wrap=True).place(relx = 0.56, rely = 0.79,anchor = 'w')
    return var_3UTR


def graphical_filter_genic_transcripts_strat1(sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> IntVar:
    """
    ...
    label = customtkinter.CTkLabel(sidebar_frame_right, text="Filter splice variants of genic transcripts",font=my_font).place(relx = 0.02, rely = 0.86,anchor = 'w')
    # Define a Checkbox
    case_filter_TE = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="False", variable=var_filter_genic, value=1).place(relx = 0.02, rely = 0.9,anchor = 'w')
    case_no_filter_TEs = customtkinter.CTkRadioButton(master=sidebar_frame_right, text="True", variable=var_filter_genic, value=2).place(relx = 0.18, rely = 0.9,anchor = 'w')
    return var_filter_genic


def graphical_start_codon(win, sidebar_frame_right : customtkinter.CTkFrame, my_font : tuple) -> StringVar:
    label = customtkinter.CTkLabel(sidebar_frame_right, text="Enter start codon : ",font=my_font).place(relx = 0.02, rely = 0.97,anchor = 'w')
...
def graphical_recip_best_hits_strat1(sidebar_frame_south : customtkinter.CTkFrame, my_font : tuple) -> IntVar:
    """
    ...
    label = customtkinter.CTkLabel(sidebar_frame_south, text="Reciprocal BEST hits",font=my_font).place(relx = 0.02, rely = 0.1,anchor = 'w')
    # Define a Checkbox
    case_filter_TE = customtkinter.CTkRadioButton(master=sidebar_frame_south, text="False", variable=var_rec_best_hit, value=1).place(relx = 0.02, rely = 0.2,anchor = 'w')
    case_no_filter_TEs = customtkinter.CTkRadioButton(master=sidebar_frame_south, text="True", variable=var_rec_best_hit, value=2).place(relx = 0.18, rely = 0.2,anchor = 'w')
    return var_rec_best_hit


def graphical_synteny_window_strat1(sidebar_frame_south : customtkinter.CTkFrame, my_font : tuple) -> IntVar:
    """
    ...
    """
    label = customtkinter.CTkLabel(sidebar_frame_south, text="Synteny window (No synteny : 0)",font=my_font).place(relx = 0.02, rely = 0.36,anchor = 'w')
    var_synteny = IntVar(value=2)
    choice_TPM = Spinbox(sidebar_frame_south, from_=0, to=5, increment=1, textvariable=var_synteny,wrap=True).place(relx = 0.02, rely = 0.46,anchor = 'w')
    return var_synteny


def graphical_slider_event_strat1(value : float, window : Tk, dico : dict) -> None: ###### the value was already in the window
    """
    ...
    label = customtkinter.CTkLabel(window, text=str(int(value)), width=30,height=25, text_color = "#37589c",corner_radius=4,fg_color="white", font = ("Arial", 15)).place(relx = 0.5, rely = 0.68)


def graphical_percent_pos_stop_strat1(sidebar_frame_south : customtkinter.CTkFrame, my_font : tuple, dico_file_and_dir : dict) -> None:
    """
    ...
    Returns:
        None
    """
    label = customtkinter.CTkLabel(sidebar_frame_south, text="Premature STOP codons (%)",font=my_font).place(relx = 0.02, rely = 0.63,anchor = 'w')
    label = customtkinter.CTkLabel(sidebar_frame_south, text="", width=30,height=25, text_color = "#37589c",corner_radius=4,fg_color="white", font = ("Arial", 15)).place(relx = 0.5, rely = 0.68)
    label = customtkinter.CTkLabel(sidebar_frame_south, text="50", width=30,height=25, text_color = "#37589c",corner_radius=4,fg_color="white", font = ("Arial", 15)).place(relx = 0.5, rely = 0.68)
    slider = customtkinter.CTkSlider(master=sidebar_frame_south, from_=0, to=100, command= lambda value, window = sidebar_frame_south, dico = dico_file_and_dir : graphical_slider_event_strat1(value, window, dico)).place(relx=0.02, rely=0.73, anchor="w")
...
def my_graphical_interface_strategy1() -> dict:
    ...
    canvas = Canvas(win)
    canvas.configure(width=img.width(), height=img.height(),  bg="#222323", highlightbackground = "#252627") #
    canvas.create_image(img.width()/2,img.height()/2,image=img)
    canvas.place(relx=0.2, rely=0.9, anchor=CENTER)

    customtkinter.set_appearance_mode("dark")
    my_font = customtkinter.CTkFont(family="Courier", size=15, weight="bold", underline=False, overstrike=False)

    # Set the geometry of Tkinter frame
    win.geometry("1000x690")


    sidebar_frame_left = customtkinter.CTkFrame(master=win, width=450, height=280, corner_radius=5)
    sidebar_frame_left.place(relx = 0.03, rely = 0.21,anchor = 'w')
    sidebar_frame_left.grid_rowconfigure(4, weight=1)

    sidebar_frame_right = customtkinter.CTkFrame(master=win, width=420, height=640, corner_radius=5)
    ...
    sidebar_frame_south = customtkinter.CTkFrame(master=win, width=450, height=240, corner_radius=5)
    sidebar_frame_south.place(relx = 0.03, rely = 0.65,anchor = 'w')
    sidebar_frame_south.grid_rowconfigure(4, weight=1)

    closed_start = customtkinter.CTkFrame(master=win,width=100,height=50, corner_radius=5,fg_color="#789bbd")
    closed_start.place(relx = 0.05, rely = 0.91,anchor = 'w')
    closed_start.grid_rowconfigure(4, weight=1)
    label = customtkinter.CTkLabel(closed_start, text="RUN", width=30,height=25,corner_radius=4, font = ("Courier", 16)).place(relx = 0.32, rely = 0.3)


    radiobutton_frame = customtkinter.CTkFrame(win, width=440, height=80, corner_radius=5, fg_color="#484747")
    radiobutton_frame.place(relx = 0.035, rely = 0.08,anchor = 'w', )

    ### variables

    dico_file_and_dir = {"strategy": "1",
                        "query" : "",
    ...
    # databases
    value_ref_name =  graphical_enter_mandatory_strat1(win, radiobutton_frame, my_font, dico_file_and_dir)
    var_blastp_mode, var_blastnucl_mode = graphical_enter_databases_strat1(sidebar_frame_left, my_font, dico_file_and_dir)
    ...
    var_undir_transcr = graphical_remove_undir_transcripts_strat1(sidebar_frame_right, my_font)
    var_intergenic, var_intronic, var_antisense, var_genic = graphical_transcript_location_strat1(sidebar_frame_right, my_font)
    ...
    var_filter_genic = graphical_filter_genic_transcripts_strat1(sidebar_frame_right, my_font)
    ...
    if var_intergenic.get() == 0 and "intergenic" in dico_file_and_dir["transcript_overlap"]:
        dico_file_and_dir["transcript_overlap"].remove("intergenic")

    if var_intergenic.get() == 1 and "intergenic" not in dico_file_and_dir["transcript_overlap"]:
        dico_file_and_dir["transcript_overlap"].append("intergenic")

    if var_intronic.get() == 0 and "intronic" in dico_file_and_dir["transcript_overlap"]:
        dico_file_and_dir["transcript_overlap"].remove("intronic")

    if var_intronic.get() == 1 and "intronic" not in dico_file_and_dir["transcript_overlap"]:
        dico_file_and_dir["transcript_overlap"].append("intronic")   

    if var_antisense.get() == 0 and "antisense" in dico_file_and_dir["transcript_overlap"]:
        dico_file_and_dir["transcript_overlap"].remove("antisense")

    if var_antisense.get() == 1 and "antisense" not in dico_file_and_dir["transcript_overlap"]:
    ...
    if var_orf_choice.get() == 2 and ["longest"] not in dico_file_and_dir["ORFs_choice"]:
    ...
    if var_orf_choice.get() == 3 and ["kozac_highest"] not in dico_file_and_dir["ORFs_choice"]:
    ...
    if var_orf_choice.get() == 4 and ["start_first"] not in dico_file_and_dir["ORFs_choice"]:
