...
def perform_blast_nucl_homology_filter(name_output_directory : str, name_intermediate_directory : str, path_to_db : str, parameters_db : dict) -> None: 
    """
    ...
    command2 = "blastn -evalue " + parameters_db["e_value"] + " -query " + location_denovo_nucl + " -db " + path_to_db + " -out " + name_output + " -outfmt \"7 qacc sacc evalue Identities qstart qend sstart send qcovs\""
...
def perform_blast_prot_transcripts(name_intermediate_directory : str, name_output_directory : str) -> None:
    """
    ...
    """
    path_target_prot = name_intermediate_directory + "/Intermediate_prot_BLAST/target_prot.fa"
    ...
    command2 = "./diamond blastp -d target_prot -q " + path_query + " --more-sensitive -o " + link_to_blast_output
...
def perform_blast_prot_homology_filter(name_output_directory : str, name_intermediate_directory : str, path_to_db : str, parameters_db : dict) -> None:
    """
    Performs a protein BLAST search using the DIAMOND tool between query and target protein sequences.
    ...
    command2 = "./diamond blastp -d " + name_database + " -q " + location_denovo_prot + " " + parameters_db["mode"] + " -o " + name_output
...
def perform_blast_to_genome(ID_genome : str, link_to_my_target_genome : str, name_output_directory : str) -> int:
    """
    ...
    """
    name_intermediate_directory = name_output_directory + "/Intermediate_output/blast_denovo_to_target_genome"
    ...
    link_db_output = name_output_directory + "/Intermediate_output/output_last_blast_to_genome_makedb.txt"
    ...
    command = "blastn -evalue " + parameters_blast_genome["e_value"] + " -query " + name_my_query + " -db " + link_to_my_target_genome + " -out " + name_output + " -outfmt \"7 qacc sacc evalue Identities qstart qend sstart send qcovs\""
    
    # Executing the BLAST search command
    link_output_blast = name_output_directory + "/Intermediate_output/output_last_blast_to_genome.txt"
...
def get_transcription_hits(dico_target_species_lines : dict, pop_species_name : str, name_output_directory : str) -> dict:
    """
    ...
    if "transcriptome_gtf" in dico_target_species_lines[pop_species_name]:
        ...
        link_transc_db = name_output_directory + "/Intermediate_output/output_last_blast_denovo_to_homolog_db.txt"
        ...
        link_blast_output = name_output_directory + "/Intermediate_output/transcript_blast_output.txt"
        command2 = "blastn -evalue 0.01 -query " + link_denovo_nucl + " -db " + link_transcripts_fasta + " -out " + link_blast_output + " -outfmt \"7 qacc sacc evalue Identities qstart qend sstart send qcovs\""
        link_transc_blast_out = name_output_directory + "/Intermediate_output/output_last_blast_denovo_to_homolog.txt"
