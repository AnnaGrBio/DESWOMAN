...
from module_orfs import build_dict_orfs_per_transcript
from module_my_bedtool import define_start_gtf
...
def reverse_sequence(transcript : str) -> str: 
    ...
    """
    reverse = ""
    Dico = {"A":"T", "T":"A", "G":"C", "C":"G", "N":"N","a":"t", "t":"a", "g":"c", "c":"g", "n":"n", "y":"y", "Y":"Y", "U":"U", "u":"u", "R":"R", "r":"r", "K":"K", "k":"k", "M":"M", "m":"m", "S":"S", "s":"s", "W":"W", "w":"w", "B":"B", "b":"b", "D":"D", "d":"d", "H":"H", "h":"h", "V":"V", "v":"v"}
...
def build_new_spliced_transcript(list_transcript_elts : list, dict_chromosomes_fasta : dict, direction_transcription : str) -> (str, dict):
    """
...
def rebuild_spliced_orfs(genome_file : str, dict_gene_structure : dict, dict_orfs : dict, name_intermediate_directory : str) -> dict:
    """
    ...
    dic_nucl_translation = {"A":"T", "T":"A", "G":"C", "C":"G", "N":"N","a":"t", "t":"a", "g":"c", "c":"g", "n":"n", "y":"y", "Y":"Y", "U":"U", "u":"u", "R":"R", "r":"r", "K":"K", "k":"k", "M":"M", "m":"m", "S":"S", "s":"s", "W":"W", "w":"w", "B":"B", "b":"b", "D":"D", "d":"d", "H":"H", "h":"h", "V":"V", "v":"v"}
    total = 0
    ...
    for transcript_name in dict_gene_structure:
        if transcript_name in dict_transcrit_all_orfs:  # remove transcripts that do not have an ORF
            ...
            for orf_name in dict_transcrit_all_orfs[transcript_name]:
                ...
                if orf_name in dict_orfs:
                    ...
                    elif orientation_transcript == "-":  # Decouverte donc, les "." sont des forward ou des reverse selon les transcripts
                        # reconstruct spliced transcript from the genome based on the exon intron structure of the transcript contrinaed in the gtf
                        reconstructed_spliced_transcript, dict_pos_spliced_transcript = build_new_spliced_transcript(list_transcript_elts, dict_chromosomes_fasta, "-")
...
def add_stop_codon_to_spliced_orfs(dict_pos_unspliced_ORFs_plus_stop : dict, dict_all_ORFs : dict) -> dict: 
    """
...
def get_dot_orientation(genome_file : str, dict_transcripts_properties : dict, dict_transcript_fasta_all : dict, gtf_file : str, name_intermediate_directory : str) -> None:
    """
    ...
    for transcript_name in dict_gene_exon_pos:
        ...
        if transcript_name in dict_transcripts_properties and dict_transcripts_properties[transcript_name][1] == ".":
            ...
            reconstructed_spliced_transcript, dict_pos_spliced_transcript = build_new_spliced_transcript(list_transcript_elts, dict_chromosomes_fasta, "+")
            reconstructed_spliced_transcript = reconstructed_spliced_transcript[2:len(reconstructed_spliced_transcript) - 1]
            # if the recontructed transcript in forward position corresponds to the transcripts : nb_plus positif takes 1
            if reconstructed_spliced_transcript == dict_transcript_fasta_all[transcript_name]:
                nb_plus += 1
            nb_tot += 1
