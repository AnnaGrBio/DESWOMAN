...
def build_dico_seq_denovo_filtered_candidates(dico_denovo_best_hit : dict, name_output_directory : str) -> dict:
    """
...
def build_dico_seq_NcHomologs(dico_denovo_best_hit : dict, link_to_genome : str, pop_name : str) -> dict:
    """
