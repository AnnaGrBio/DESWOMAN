...
def reshufe_files_in_denovo(name_output_directory : str, list_denovo_to_delete : list) -> None:
    """
    ...
    denovo_unspliced_lowered_introns_file = name_output_directory + "/denovo_unspliced_lowered_introns.fa"
