...
def extract_all_blast_outputs(sp_pop_ind_name : str, name_intermediate_directory : str) -> dict:
    """
    ...
    my_file_name = name_intermediate_directory + "/blast_denovo_to_target_genome/" + sp_pop_ind_name + "_all_bast_output.txt"
...
def extract_best_blast_outputs(sp_pop_ind_name : str, name_intermediate_directory : str) -> dict:
    """
