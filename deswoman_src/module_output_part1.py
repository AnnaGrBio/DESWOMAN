...
def create_new_folder_intermediate(name_output_directory : str, name_intermediate_directory : str) -> None:
    """
...
def create_unspliced_orfs(name_output_directory : str, dict_unspliced_orfs_fasta_lowered_introns : dict) -> None:
    """
...
def create_denovo_nucl_file(name_output_directory : str, dict_all_ORFs_filtered_with_stop : dict) -> None:
    """
...
def create_denovo_transcripts_file(name_output_directory : str, dict_transcript_fasta_denovo : dict) -> None:
    """
...
def create_info_file_orfs(name_output_directory : str, dict_transcripts_properties : dict, dict_gene_status : dict, dict_gene_transcripts_denovo : dict, dict_transcrit_filtered_orfs : dict, dict_pos_unspliced_ORFs_plus_stop : dict, sublist_transcripts_overlap : list) -> None:
    """
    ...
    my_file.write("gene_name,chromosome,orientation,putative_genic_variant,nb_denovo_transcripts,transcript_name,transcript_start_in_genome_B1,transcript_end_in_genome_B1,nb_filtered_orf,neORF_candidate,neORF_start_in_genome_B0,neORF_end_in_genome_B0,genomic_overlap"+"\n")
                ...
                for orf_name in list_orf:
                    if orf_name in dict_pos_unspliced_ORFs_plus_stop:
                        ...
                        if int(my_orf_start_in_genome) < int(my_orf_stop_in_genome):
                            ...
                            my_file.write(my_gene_name+","+my_chrom+","+my_direction+","+my_gene_status+","+my_nb_denovo_transcripts+","+my_transcript_name+","+my_transcript_start+","+my_transcript_stop+","+my_nb_filtered_orfs+","+my_orf_name+","+my_orf_stop_in_genome+","+my_orf_start_in_genome+","+transcript_overlap+"\n")
    my_file.close()
