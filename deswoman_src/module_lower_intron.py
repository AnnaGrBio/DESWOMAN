...
from module_unspliced_orfs import build_dict_chrom, reverse_sequence
...
def build_dico_intron_exon_specified(dict_gene_exon_pos : dict, transcript_name : str) -> (dict, dict):
    """
...
def build_unspliced_fasta_seq_lowered_intron(dict_pos_unspliced_ORFs_plus_stop : dict, genome_file : str, dict_gene_exon_pos : dict) -> dict:
    """
